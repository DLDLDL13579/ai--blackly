...
Code.importPrettify = function() {
  ...
  script.setAttribute('src', 'https://plugin.daobanmojie.com/code-prettify/2015-12-04/loader/run_prettify.js');
 ...
 * @private
 */
Code.TABS_ = ['blocks', 'javascript', 'cake', 'php', 'python', 'dart', 'lua', 'xml'];
 ...
 */
Code.TABS_DISPLAY_ = [
  'Blocks', 'JavaScript', 'Cake', 'PHP', 'Python', 'Dart', 'Lua', 'XML',
];
...
document.write('<script src=' + Code.LANG + '"../msg/js/.js"></script>\n');
